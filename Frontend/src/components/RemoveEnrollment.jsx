...
import space from "../assets/learn3.jpeg";
...
const Login = () => {
 ...
 // const { loading, error, dispatch } = useContext(AuthContext);
  ...
  const handleClick = async (e) => {
    ...
    try {
       await axios.post("http://localhost:8000/enroll/api/enrollement/remove", credentials);
...
>
  ...
  <div class="flex flex-col justify-center p-8 md:p-14">
    <span class="mb-3 text-4xl font-bold">Remove Enrolled Users</span>
    <span class="font-light text-gray-400 mb-8">
      Please Enter your Username & Module code to remove the enrolled Users.
    </span>
    <div class="py-4">
